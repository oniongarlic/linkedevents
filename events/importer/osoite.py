...
class OsoiteImporter(Importer):
    ...
    def setup(self):
        ...
        self.data_source_org, _ = DataSource.objects.get_or_create(defaults=defaults, **ds_args)         
        
        #public organization class for all places
        ds_args = dict(origin_id='12', data_source=self.data_source_org)
        ...
        '''
        self.data_source = DataSource.objects.get(id='osoite')
